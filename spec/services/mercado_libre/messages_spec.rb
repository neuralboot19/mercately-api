...
RSpec.describe MercadoLibre::Messages, vcr: true do
  ...
  describe '#import' do
    context 'when the message comes from the customer' do
      context 'and customer is the same of the order' do
      ...
      context 'and customer is not the same of the order' do
    ...
    context 'when the message is sent from ML' do
      context 'when te message comes from the retailer' do
        context 'and the retailer is the same of the customer of the order' do
          it 'saves the message' do
        ...
        context 'and the retailer is not the same of the customer of the order' do
