class KarixCustomerSerializer < ActiveModel::Serializer
  attributes :id, :first_name, :last_name, :email, :phone, :address, :city, :state, :zip_code,
             :id_number, :whatsapp_name, :unread_whatsapp_chat, :whatsapp_opt_in, :tags, :unread_whatsapp_message?,
             :recent_inbound_message_date, :assigned_agent, :last_whatsapp_message, :recent_message_date,
             :handle_message_events?, :unread_whatsapp_messages
